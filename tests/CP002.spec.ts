...
test('Creación de un Certificado y visualización del mismo', async ({ page }) => {
  ...
  await page.getByRole('row', { name: 'CURSO ABIERTO SIN TEMAS - CON NOTA - ONLINE horizontal  DIPLOMA CON MARCO SANTANDER CEINN  Elegir', exact: true }).getByRole('button').click();
